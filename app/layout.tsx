...
import { Inter, Playfair_Display, Red_Rose } from "next/font/google";
...
export default function RootLayout({
  ...
  return (
    <html
      ...
      className={`${inter.variable} ${playfair.variable} ${nasalization.variable} ${redRose.variable} antialiased`}
    >
      <body>
        <Navbar />
        {children}
